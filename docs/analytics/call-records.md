# Obtaining Individual Call Record with Business Analytics Data
...
One can use our [interactive API Reference](https://developers.ringcentral.com/api-reference/Business-Analytics/analyticsCallsRecordsFetch) to not only create an API Request but also run it interactively and see the response.
