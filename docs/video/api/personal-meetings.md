...
=== "Javascript"
    ...
    ```js
    --8<-- "code-samples/video/personal-meeting.js"
    ```

=== "Python"

    ```python
    --8<-- "code-samples/video/personal-meeting.py"
    ```

=== "PHP"

    ```php
    --8<-- "code-samples/video/personal-meeting.php"
    ```

=== "Ruby"

    ```ruby
    --8<-- "code-samples/video/personal-meeting.rb"
    ```
...
```json
--8<-- "code-samples/video/personal-meeting.json"
```
